...
import bannerImage from "../img/homescreen4.jpg";
    ...
    <div className="content">
      ...
      >
        <div className="title-wrapper">
          ...
          <div className="subheading">Canadian Mooving Company</div>
        ...
        <div className="content-container">
          ...
          <div className="content-row">
            <div className="row-25">
              ...
              <p>
                AutoCentaur ensures that your belongings are packed with utmost
                care. Our expert packers use the best materials and techniques
                to protect your items, making sure they arrive safely at their
                destination.
              </p>
            </div>
            <div className="row-25">
            ...
            <div className="row-25">
              ...
              <p>
                Quality doesn't always have to come at a high price. AutoCentaur
                offers top-notch moving services at prices that fit your budget,
            ...
            <div className="row-25">
              ...
              <p>
                ...
                importance of time, which is why our trained professionals are
                committed to providing rapid yet precise relocation services.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="action-container">
          <div className="action-row">
            <div className="action-text">
              <h2>
                Secure your smooth move with AutoCentaur today. Get your quote
                now!
              </h2>
            </div>
